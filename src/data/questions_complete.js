const data = [
    ...
    questions: [
        ...
        {
            question: "Qual atributo deixa a input obrigatório?",
            options: ["placeholder","value","required","maxlength"],
            answer: "required",
        },
        {
            question: "A tag semântica indicada para rodapés é da:",
    ...
    },
    {
        ...
        questions: [
            {
                question: "O que é Vanilha JavaScript?",
                options: [
                    "JavaScript puro",
            ...
            {
                question: "Qual instrução declaramos uma constante em Javascript?",
